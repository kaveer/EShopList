...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonGenerateList   = (Button) findViewById(R.id.buttonTest);
        buttonGenerateList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast messageBox = Toast.makeText(MainActivity.this , "Test successful" , Toast.LENGTH_LONG);
                messageBox.show();
            }
        });
